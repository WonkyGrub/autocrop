...
REQUIRED = ["numpy>=1.10", "opencv-python-headless>=3, <5", "Pillow>=9.0.0", "shapely", "cropimage", "facenet_pytorch"]
...
setup(
    ...
    entry_points={"console_scripts": ["autocrop=autocrop:command_line_interface"]},
